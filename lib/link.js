...
exports.link = function(name, dir) {
  ...
  .then(function() {
    ...
    try {
      if (fs.existsSync(linkDir)) {
        return ui.confirm('`' + pkg.exactName + '` is already linked, are you sure you want to override it?', true)
...
exports.lookup = function(pkg) {
  var linkFolder = path.resolve(process.env.HOME, '.jspm', 'linked', pkg.endpoint);
  ...
  .then(function(files) {
    ...
    .filter(function(file) {
      return file.substr(0, file.lastIndexOf('@')) == pkg.package;
    })
